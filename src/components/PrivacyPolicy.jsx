...
function PrivacyPolicy() {
  ...
  return (
    ...
    <div className="privacy-container">
      ...
      {/* <section className="privacy-section fade-in">
        <h2 className="privacy-heading">6. Cookies</h2>
        <p>
          Our website uses cookies to enhance your browsing experience. Cookies help us understand user behavior, remember preferences, and improve site functionality. You can modify your browser settings to disable cookies at any time.
        </p>
      </section> */}
      ...
      <section className="privacy-section fade-in">
        ...
        <p>
          You have the right to access, modify, or delete your personal information. If you would like to request a data update or removal, please contact us at <a href="mailto:info@aanyasolutions.net">info@aanyasolutions.net</a>.
        </p>
      </section>
      ...
      <section className="privacy-section fade-in">
        ...
        <p>
          ...
          <br />
          <strong>Email:</strong> info@aanyasolutions.net
        </p>
      </section>
    </div>
    <Whatsapp/>
